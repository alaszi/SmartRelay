...
export default defineConfig({
  ...
  // require() of Node built-ins that bundled ESM output cannot resolve. Both are pulled in
  // transitively via @smartrelay/engine and @smartrelay/db, and both are direct dependencies
  // here too so they're always installed alongside the built app.
